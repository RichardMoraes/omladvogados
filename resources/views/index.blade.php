...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
      <a href="login" class="w3-bar-item w3-button">Area do Cliente</a>
...
<nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
  ...
  <a href="#atuacao" onclick="w3_close()" class="w3-bar-item w3-button">Atuação</a>
  <a href="#equipe" onclick="w3_close()" class="w3-bar-item w3-button">Equipe</a>
...
<div class="w3-container" style="padding:128px 16px" id="team">
  <h3 class="w3-center">Nossa Equipe</h3>
  <div class="w3-row-padding w3-grayscale" style="margin-top:64px">
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <div class="w3-container">
          <h3>Dr. Cláudio Alberto Merenciano</h3>
          <p class="w3-opacity">CEO & Fundador</p>
          <p>Formação Acadêmica: Graduado pela Faculdades Metropolitanas Unidas (FMU)
Pós-Graduação: Direito Empresarial</p>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <div class="w3-container">
          <h3>Drª. Rosana Olivério Merenciano</h3>
          <p class="w3-opacity">Co-fundadora</p>
          <p>Formação Acadêmica: Graduada pela Pontifícia Universidade Católica (PUC)
Pós-Graduação: Direito Processo Civil.</p>
          <p><button class="w3-button w3-light-grey w3-block"><i class="fa fa-envelope"></i> Contato</button></p>
        </div>
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <div class="w3-container">
          <h3>Drª. Cilene Cristine da Silva</h3>
          <p class="w3-opacity">Advogada</p>
          <p>Formação Acadêmica: Graduada pela Universidade Guarulhos (UNG)
Especialidade: Direito do Trabalho</p>
          <p><button class="w3-button w3-light-grey w3-block"><i class="fa fa-envelope"></i> Contato</button></p>
        </div>
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <div class="w3-container">
          <h3>Wilson Roberto Cesário Junior</h3>
          <p class="w3-opacity">Advogado</p>
          <p>Formação Acadêmica: Faculdade Diadema (FAD)
...
<iframe
  ...
  allowfullscreen
  src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAq8xjLy9LmxuWU6aEqVtJwMd86TmbrfIY
    &q=advocacia+oliverio+merenciano&zoom=17">
</iframe>
</div>
